# Moxfield Latest — Cards with Precon Assignments (generated 2026-05-08T17:38:20.170379+00:00Z)
...
|Hammer of Nazahn|sld|1|SonictheHedgehog TurboGear (alt)||
...
|Lightning Greaves|soc|1|PrismariArtistry; SonictheHedgehog TurboGear (alt)||
|Lightning Greaves|sld|1|PrismariArtistry; SonictheHedgehog TurboGear (alt)||
...
|Myr|sld|1|SonictheHedgehog TurboGear (alt)||
|Myr Battlesphere|sld|1|SonictheHedgehog TurboGear (alt)||
...
|The Reaver Cleaver|sld|1|SonictheHedgehog TurboGear (alt)||
...
|Weatherlight|sld|1|SonictheHedgehog TurboGear (alt)||
...
Expected total quantity (from decklist): 100
Matched total quantity in CSV (exact + heuristics): 179
